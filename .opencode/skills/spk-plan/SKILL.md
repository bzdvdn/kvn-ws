---
name: spk-plan
description: SpecKeep-фаза «plan» — Create or update plan artifacts for one feature.
---
...
- readiness: ./.speckeep/scripts/check-ready.sh plan [<slug>] (запусти, доверяй exit-коду).
...
- Канонический источник (синхронизируется автоматически): .speckeep/templates/prompts/plan.md
