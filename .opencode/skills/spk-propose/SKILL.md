---
name: spk-propose
description: SpecKeep-фаза «propose» — One-shot: turn an idea into spec + tasks (plan optional) and go straight to implement.
---
...
- readiness: ./.speckeep/scripts/check-ready.sh propose [<slug>] (запусти, доверяй exit-коду).
...
- Канонический источник (синхронизируется автоматически): .speckeep/templates/prompts/propose.md
