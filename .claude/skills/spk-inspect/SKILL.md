---
name: spk-inspect
description: SpecKeep-фаза «inspect» — Inspect one feature for consistency and quality.
---
...
- readiness: ./.speckeep/scripts/check-ready.sh inspect [<slug>] (запусти, доверяй exit-коду).
...
- Канонический источник (синхронизируется автоматически): .speckeep/templates/prompts/inspect.md
