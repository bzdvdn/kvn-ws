---
name: spk-verify
description: SpecKeep-фаза «verify» — Verify one implemented feature package.
---
...
- readiness: ./.speckeep/scripts/check-ready.sh verify [<slug>] (запусти, доверяй exit-коду).
...
- Канонический источник (синхронизируется автоматически): .speckeep/templates/prompts/verify.md
