---
name: spk-implement
description: SpecKeep-фаза «implement» — Implement one feature from tasks.
---
...
- readiness: ./.speckeep/scripts/check-ready.sh implement [<slug>] (запусти, доверяй exit-коду).
...
- Канонический источник (синхронизируется автоматически): .speckeep/templates/prompts/implement.md
