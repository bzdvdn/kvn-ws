---
name: spk-tasks
description: SpecKeep-фаза «tasks» — Create or update tasks for one feature.
---
...
- readiness: ./.speckeep/scripts/check-ready.sh tasks [<slug>] (запусти, доверяй exit-коду).
...
- Канонический источник (синхронизируется автоматически): .speckeep/templates/prompts/tasks.md
